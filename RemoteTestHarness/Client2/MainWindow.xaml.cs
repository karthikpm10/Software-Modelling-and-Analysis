...
namespace Client2
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            LibFiles.Text = System.IO.Path.GetFullPath(repoPath);
            TestRequest.Text = System.IO.Path.GetFullPath(testRequestPath);
            hostClient();
        ...
        public void testExecutive()
        {
            ...
            //upload files
            List<string> listFiles = new List<string>(System.IO.Directory.GetFiles(System.IO.Path.GetFullPath(repoPath) + "\\", "*.dll"));
            if (listFiles.Count > 0)
            {
                ...
                testRquestDoc = XDocument.Load(System.IO.Path.GetFullPath(testRequestPath));
                ...
                logMessage.to = Comm<Client3>.makeEndPoint(url, repoPort);
                logMessage.from = Comm<Client3>.makeEndPoint(url, clientPort);
        ...
        {
            string rcvrEndPoint = Comm<Client3>.makeEndPoint(url, clientPort);
            try
            {
        ...
        {
            string senderEndPoint1 = Comm<Client3>.makeEndPoint(url, repoPort);
